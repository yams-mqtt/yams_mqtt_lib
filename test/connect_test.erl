...
?assertEqual({error, 'invalid_will', <<4:16, "MQTT", 4:8, 0:1, 1:1, 0:1, 1:2, 0:1, 0:1, 0:1, 1:16>>}, 
	     (connect:get_vh(<<4:16, "MQTT", 4:8, 0:1, 1:1, 0:1, 1:2, 0:1, 0:1, 0:1, 1:16>>))).

get_vh_invalid_will_2_test() ->
?assertEqual({error, 'invalid_will', <<4:16, "MQTT", 4:8, 0:1, 1:1, 0:1, 2:2, 0:1, 0:1, 0:1, 1:16>>}, 
	     (connect:get_vh(<<4:16, "MQTT", 4:8, 0:1, 1:1, 0:1, 2:2, 0:1, 0:1, 0:1, 1:16>>))).

get_vh_invalid_will_3_test() ->
?assertEqual({error, 'invalid_will', <<4:16, "MQTT", 4:8, 0:1, 0:1, 1:1, 0:2, 0:1, 0:1, 0:1, 1:16>>}, 
	     (connect:get_vh(<<4:16, "MQTT", 4:8, 0:1, 0:1, 1:1, 0:2, 0:1, 0:1, 0:1, 1:16>>))).

get_vh_invalid_will_4_test() ->
?assertEqual({error, 'invalid_will', <<4:16, "MQTT", 4:8, 0:1, 1:1, 1:1, 2:2, 0:1, 0:1, 0:1, 1:16>>}, 
